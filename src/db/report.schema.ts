...
export const reportCommentaryItems = sqliteTable(
...
// pipeline.
export const reportDeliveryProfiles = sqliteTable(
  "monthly_report_delivery_profiles",
  {
    ...
    attachPdf: integer("attach_pdf", { mode: "boolean" })
      .notNull()
      .default(true),
    includeShareLink: integer("include_share_link", { mode: "boolean" })
      .notNull()
      .default(true),
...
export const reportDeliveryProfileSections = sqliteTable(
...
export const reportShareLinks = sqliteTable(
