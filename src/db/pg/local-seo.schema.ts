...
export const localListingConnections = pgTable(
  "local_listing_connections",
  {
    ...
    statusSource: text("status_source", { enum: ["api", "manual", "audit"] })
      .notNull()
      .default("manual"),
...
export const geoGridConfigs = pgTable(
  "geo_grid_configs",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const geoGridCells = pgTable(
  "geo_grid_cells",
  {
    id: text("id").primaryKey(),
    runId: text("run_id")
...
export const citationAuditRuns = pgTable(
  "citation_audit_runs",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const citationObservations = pgTable(
  "citation_observations",
  {
    ...
    addressMatches: boolean("address_matches"),
    phoneMatches: boolean("phone_matches"),
    websiteMatches: boolean("website_matches"),
