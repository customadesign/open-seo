...
const dataEnv = {
  ...
  GOOGLE_ADS_DEVELOPER_TOKEN: optionalSecret("GOOGLE_ADS_DEVELOPER_TOKEN"),
  ...
  REPORT_PDF_RENDER_URL: optionalVar("REPORT_PDF_RENDER_URL"),
  REPORT_PDF_RENDER_BEARER_TOKEN: optionalSecret(
    "REPORT_PDF_RENDER_BEARER_TOKEN",
  ),
  RESEND_API_KEY: optionalSecret("RESEND_API_KEY"),
  REPORT_EMAIL_FROM: optionalVar("REPORT_EMAIL_FROM"),
  REPORT_EMAIL_REPLY_TO: optionalVar("REPORT_EMAIL_REPLY_TO"),
  REPORT_DELIVERY_TEST_MODE: optionalVar("REPORT_DELIVERY_TEST_MODE"),
  REPORT_TEST_RECIPIENTS: optionalVar("REPORT_TEST_RECIPIENTS"),
